...
export function fakeAdapter(): ActualApiAdapter {
  return {
    ...
    holdBudgetForNextMonth: vi.fn().mockResolvedValue(false),
    ...
    createSchedule: vi.fn().mockResolvedValue('schedule-id'),
    updateSchedule: vi.fn().mockResolvedValue('schedule-id'),
